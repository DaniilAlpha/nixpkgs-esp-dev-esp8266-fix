{
  ...
  outputs =
    ...
    }:
    {
      ...
      overlays.esp8266 = import ./overlay-esp8266.nix;
    }
	...
	pkgs-old = import nixpkgs-old {
	 inherit system; 
          overlays = [ self.overlays.esp8266 ];
	};
      in
      {
        packages = {
        ...
        devShells = rec {
          ...
          esp8266-rtos-sdk = import ./shells/esp8266-rtos-sdk.nix { inherit pkgs-old; }; # Broken
          esp8266-nonos-sdk = import ./shells/esp8266-nonos-sdk.nix { inherit pkgs; };
        };

        checks =
          (import ./tests/build-idf-examples.nix { inherit pkgs; }) //
          (import ./tests/build-esp8266-example.nix { inherit pkgs-old; });
      }
    );
}
